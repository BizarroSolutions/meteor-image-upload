Package.describe({
  name:    "bizarro:semantic-image-upload",
  version: "0.9.0",
  summary: "Let users upload images in your app with semantic-ui style",
  git:     "https://github.com/BizarroSolutions/meteor-image-upload"
});
